...
<div class="form">
      ...
      <div class="icontainer i1">
        ...
        <div class="cut"></div>
        <label for="vehicleid" class="placeholder">Registration Number</label>
      </div>
      ...
      <div class="icontainer i2">
       ...
       <label class="subtitle">Upload Vehicle Images</label><br><br>
...
function valid(){
    	...
    	var f= document.getElementById("vehicleid").value;
    	
    	
    	if(f==""){
    	alert("registered no is empty");
    	return false;
