...
<header>
	<div class="overlay">
<h1>Simply Find Your Dream Vehicle</h1>
<h3>Reasons for Choosing US</h3>
<p>WS Property Management Society Since 1990</p>
	<br>
	
	<button><a href="home.jsp" target="_blank">Back to home</a></button>
  ...
  <div class="card">
    ...
    <div class="contentBx">
      ...
      <div class="size" style="height: 30px;">
        <h3>Registered No</h3><h3><%=resultSet.getString("regno")%></h3>
       
      </div>
      <div class="size" style="height: 30px;">
        <h3>Brand</h3><h3><%=resultSet.getString("brand")%></h3>
        
      </div>
      <div class="size" style="height: 30px;">
       <h3>Year</h3> <h3><%=resultSet.getString("year")%></h3>
        
      </div>
      <div class="size" style="height: 30px;">
        <h3>Mileage</h3><h3><%=resultSet.getString("mileage")%></h3>
      
      </div>
      <div class="size" style="height: 30px;">
         <h3>Owner Name</h3> <h3><%=resultSet.getString("oname")%></h3>
